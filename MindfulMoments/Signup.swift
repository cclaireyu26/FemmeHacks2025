...
struct Signup: View {
    ...
    var body: some View {
        ...
        NavigationStack{
            VStack{
                Text("Mindful Moments").font(.custom("Cochin", fixedSize: 35)).foregroundColor(Color(red: 5 / 255, green: 10 / 255, blue: 48 / 255))
                Text("Create a new account").font(.custom("Cochin", fixedSize: 25)).foregroundColor(Color(red: 5 / 255, green: 10 / 255, blue: 48 / 255))
