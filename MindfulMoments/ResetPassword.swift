        ...
        NavigationStack{
            VStack{
                ...
                TextField("user123", text:$username).multilineTextAlignment(.center).font(.title3)
                    .border(Color.black, width:2).textFieldStyle(RoundedBorderTextFieldStyle()).cornerRadius(10.0).overlay(RoundedRectangle(cornerRadius:10.0).stroke(.black,lineWidth:2)).padding()
                Text("New password").font(.custom("Cochin", fixedSize: 20)).foregroundColor(Color(red: 5 / 255, green: 10 / 255, blue: 48 / 255))
                ...
                Text("Enter the recovery word that you previously set.").font(.custom("Cochin", fixedSize: 17)).foregroundColor(Color(red: 5 / 255, green: 10 / 255, blue: 48 / 255)).padding()
